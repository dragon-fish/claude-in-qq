...
用户明确要求了才发。判断标准不是额度而是打扰：它会响在用户手机上。长任务真正结束、或者中途撞上需要
他知道的坏消息，才值得打断他一次。任务进度、阶段性汇报都不要发。
...
正常用法一天几条，够不着这些上限；撞上了基本就是有东西在自动重发。限流退出码非零、正文写明原因。
**收到拒绝就停手，在当前窗口把情况告诉用户**，不要改一个字再试一次——那只是绕开了为你设的护栏。
